...
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_PREFIX_PATH=/media/dbdu/Data/GreenSoft/Qt5.14.2/5.14.2/gcc_64  ../WizQTClient && \
make -j2
...
./WizQTClient/linuxdeployqt ./Package/wiznote.desktop -verbose=1 -appimage -qmake=/media/dbdu/Data/GreenSoft/Qt5.14.2/5.14.2/gcc_64/bin/qmake
